...
globals[1] = function(id,original,modified,injected,blocked)
    ...
    if id == 0x01a then
        ...
        if category ~= 0x03 and category ~= 0x10 then
        ...
        elseif category == 0x0f then
            ...
            if helpers["target"] ~= nil and target then
...
globals[4] = function(id,original,modified,injected,blocked)
    ...
    if id == 0x05b and helpers["megawarp"] ~= nil and helpers["megawarp"].getStatus() ~= false then
